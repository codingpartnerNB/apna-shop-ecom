            ...
            <div data-aos='zoom-in' className='grid md:grid-cols-3 pb-44 pt-5'>
                <div className='py-8 px-4'>
                    <h1 className='sm:text-3xl text-xl font-bold sm:text-left text-justify mb-3 flex items-center gap-3'>
                        ...
                        Apna Shop</h1>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus debitis explicabo neque error ipsa soluta placeat enim veniam obcaecati id modi, ipsum corrupti nulla, laborum cum, voluptate voluptas commodi quis?</p>
                </div>
